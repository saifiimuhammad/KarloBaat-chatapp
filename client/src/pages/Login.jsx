...
const Login = () => {
  ...
  return (
    ...
    { isLogin ? (
      ...
      <Button variant="text" onClick={toggleLogin} fullWidth>Signup Instead</Button>
      </form>
      </>)  : (
        <>
        ...
        <Button sx={{ marginTop: "1rem" }}  variant="contained" color="primary" type="submit" fullWidth>Signup</Button>
        <Typography textAlign="center" m="1rem">OR</Typography>
